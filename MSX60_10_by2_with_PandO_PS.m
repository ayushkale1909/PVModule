function MSX60_10_by2_with_PandO_PS()
...
Sim_program='MSX60_10_by2_PandO_PS';
...
for D=0:0.01: 1.5
[V1,I1,P1] = Sample(1.5,mdlWks,Sim_program,D);
V=[V;V1];
I=[I;I1];
P=[P;P1];
end 
...
[V,I,P] = Sample(t,mdlWks,Sim_program,Dprev);
...
function [V,I,P] = Sample(S_time,mdlWks,Sim_program,D)
assignin(mdlWks,'D',D);
